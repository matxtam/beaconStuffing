...
unsigned char *sendbuff;
 ...
 #define DESTMAC0	0x2c
 #define DESTMAC1	0xcf
 #define DESTMAC2	0x67
 #define DESTMAC3	0x36
 #define DESTMAC4	0xaa
 #define DESTMAC5	0x3a
 
 #define destination_ip 192.168.137.98
